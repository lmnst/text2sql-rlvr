...
# Defaults are the honest setting: strict verifier, no partial credit.
# The reward-hacking run flips these; see docs/grpo-runbook.md.
export TEXT2SQL_DB_ROOT=${TEXT2SQL_DB_ROOT:-/root/autodl-tmp/bird/train/train_databases}
export TEXT2SQL_REWARD_FORMAT=${TEXT2SQL_REWARD_FORMAT:-0}
export TEXT2SQL_REWARD_EXEC=${TEXT2SQL_REWARD_EXEC:-0}
export TEXT2SQL_REWARD_OFFICIAL=${TEXT2SQL_REWARD_OFFICIAL:-0}

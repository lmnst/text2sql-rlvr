...
> 最终状态（2026-08-17）：SFT、checkpoint 恢复/合并和后续公平评测均已完成。本文件保留训练
> 操作细节，其中“未验证”“计划”等描述是早期执行前记录，不代表项目当前状态。最终结果以
> `README.md`、`docs/FINAL_REPORT.md` 和 `results/runs.jsonl` 为准。
